...
nginx_conf=$sys_conf/nginx
nginx_log=$sys_log/nginx
www=/www
domains="hxlady.com 6693.cc"
...
php_libiconv=http://mirrors.ecvps.com/gnu/libiconv/libiconv-1.13.1.tar.gz
...
php=http://cn2.php.net/distributions/php-5.2.17.tar.bz2
php_fpm=http://php-fpm.org/downloads/php-5.2.17-fpm-0.5.14.diff.gz
php5_3=http://cn.php.net/distributions/php-5.3.5.tar.bz2
...
phpmyadmin=http://downloads.sourceforge.net/project/phpmyadmin/phpMyAdmin/3.3.9/phpMyAdmin-3.3.9-all-languages.tar.gz